...
$body ="Here is the message from your portal page:\n";
...
mail ('lisa.fortino06@gmail.com', $subject, $body, $from);

header('Location: thanks.html'); // replace "thx.html" with the name and path to your actual thank you page
